...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:youremail@yourdomain.com}{victorgvm2005@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+52-229-243-9690}{229 243 9690}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/victor-gabriel-vazquez-montes-0985ab31b/}{LinkedIn}}%
        \kern 5.0 pt%
        %\AND%
        %\kern 5.0 pt%
    ...
    \section{Acerca de Mi}
        ...
        \begin{onecolentry}
            Soy estudiante de actuaría en la Universidad Cristóbal Colón, con un enfoque en el análisis de datos, la programación y el sector financiero. Estoy entusiasmado por aplicar mis habilidades en un entorno profesional. Me considero una persona proactiva, con capacidad de adaptación y aprendizaje rápido. Busco oportunidades para crecer y contribuir al éxito de un equipo.
        \end{onecolentry}

    \section{Habilidades}

        \begin{onecolentry}
            \textbf{Programación:} Python, VBA, R \end{onecolentry}
                \begin{highlights}
                    \item Algunas librerías que sé emplear son: Numpy, Pandas, Matplotlib, Seaborn. 
                \end{highlights}
